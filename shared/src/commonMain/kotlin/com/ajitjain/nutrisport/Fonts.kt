...
@Composable fun bebasNeueFont() = FontFamily(Font(Res.font.bebas_neue_regular))

@Composable fun robotoCondensed() = FontFamily(Font(Res.font.roboto_condensed_medium))
